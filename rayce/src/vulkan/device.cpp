...
Device::Device(VkPhysicalDevice physicalDevice, const std::vector<const char*>& enabledValidationLayers)
{
    // We have already queried this earlier...
    ...
    // We want a separate queue for compute stuff
    ...
    const std::set<uint32> uniqueQueueFamilyIndices = { graphicsFamilyIndex, computeFamilyIndex };
